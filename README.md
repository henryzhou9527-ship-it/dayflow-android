...
- Daily view surfaces day-goal progress, focus summaries, distraction summaries, workflow heatmaps, and editable Dayflow-style standup cards for highlights, tasks, and blockers.
