...
- Weekly view supports Monday-based week navigation, focus heatmaps, weekly workflow grids, time distribution, context-shift comparison charts, top-level updates, next-step suggestions, application interaction summaries, touch treemaps, category-to-app Sankey breakdowns, and app-switching network charts.
